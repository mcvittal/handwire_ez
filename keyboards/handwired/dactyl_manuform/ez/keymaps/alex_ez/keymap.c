...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_CAPS, KC_LCTL,KC_LALT, KC_LGUI, KC_ENT,                                       KC_ENT, KC_RGUI, KC_RALT,KC_RCTL, KC_RSFT,
                                               RAISE ,KC_SPC ,        KC_INS , LOWER,
                                                      KC_HOME,        KC_END ,
                                       KC_SPC,KC_BSLS, RESET,         KC_PSCR ,KC_DEL,KC_SPC
  ),
  [_LOWER] = LAYOUT_5x6(
     KC_MUTE,KC_VOLD,KC_VOLU ,KC_MPRV,KC_MPLY,KC_MNXT,                         _______,_______,_______,KC_LCBR,KC_RCBR,KC_EQL ,
     _______,_______, _______,KC_UP ,_______,_______,                         _______,_______,_______,KC_LBRC,KC_RBRC,_______,
